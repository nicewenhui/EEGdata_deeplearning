# -*- coding: utf-8 -*-
"""
Created on Mon Nov 25 14:16:03 2019

@author: OWNER
"""

# head channels - raw motordata classification
...
#    head_chan = ['C5','C3','C1','Cz','C2','C4','C6','CP3','CP1','CP2','CP4']
#    head_chan = ['FCz','FC5','FC1','FC2','FC6','FC3','FC4','C5','C3','C1','Cz','C2','C4','C6','CP3','CP1','CP2','CP4']
    head_chan = channel[0:122]+channel[123:131]
    print(head_chan)
    print("------------------------------------------------------------------")
#    print(channel)
    head_chan_list = [channel.index(i) for i in head_chan]
    print(head_chan_list)
    ...
    for i in range(trial_num):
        if desc[i] == '1':
            ...
            data_trial.append(normalize_data[head_chan_list,events_start:events_end]) 
...
def EEGNet(nb_classes, Chans = 130, Samples = 750, 
...
model = EEGNet(nb_classes=2, Chans = 130, Samples = 750, 
             dropoutRate = 0.5, kernLength = 64, F1 =25, 
             D = 2, F2 = 50, norm_rate = 0.25, dropoutType = 'Dropout')
model.summary()

# checkpoint
filepath="D:/motorraw/weights/20191127-eegnet-motor-head-18chan-raw-2class-weights_best.hdf5"
