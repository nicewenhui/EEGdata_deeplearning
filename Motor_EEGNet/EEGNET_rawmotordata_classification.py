# -*- coding: utf-8 -*-
# ear channels - raw motordata classification
...
#    electrode-wise exponential moving standardizatio
    ...
    ear_chan = ['LF', 'LB', 'LOU', 'LOD', 'RF' ,'RB' , 'ROU', 'ROD']
    ear_chan_list = [channel.index(i) for i in ear_chan]
    ...
    for i in range(trial_num):
        if desc[i] == '1':
            ...
            data_trial.append(normalize_data[ear_chan_list,events_start:events_end]) 
...
def EEGNet(nb_classes, Chans = 8, Samples = 750, 
...
model = EEGNet(nb_classes=2, Chans = 8, Samples = 750, 
             dropoutRate = 0.5, kernLength = 64, F1 = 25, 
             D = 2, F2 = 50, norm_rate = 0.25, dropoutType = 'Dropout')
model.summary()

# checkpoint
filepath="D:/motorraw/weights/20191127-eegnet-motor-ear-8chan-raw-2class-weights_best.hdf5"
